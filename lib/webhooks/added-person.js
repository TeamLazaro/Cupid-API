...
// Exports
// module.exports = PersonAddedWebhook;
...
class PersonAddedWebhook extends Webhook {
	constructor ( clientName, phoneNumber ) {
		super();
		this.event = "/added/person";
		if ( clientName )
	...
	static getMockData () {
		...
		if ( Math.round( Math.random() ) )
			data = {
				...
				emailAddresses: [ "kue.pid@gmail.com" ]
			};
		else
			data = {
				when: "2019-10-15T12:24:30.195Z",
...
PersonAddedWebhook.prototype.handle = async function handle () {

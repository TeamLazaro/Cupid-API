...
class Person {
	constructor ( client, id_or_phoneNumber ) {

		// this.__schema = 3;
		if ( ! client || ! id_or_phoneNumber )
			throw new Error( "Please provide the client and person's id or phone number." );

		this.client = client;
		this.phoneNumber = id_or_phoneNumber;
